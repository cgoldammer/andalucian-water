...
import { setMatchResponseSeconds, getMatchResponseSecondsSelector, setViewsVisible } from '../reducers/settingsReducer'; 
import { runMode, RUNMODE_DEV, RUNMODE_MOCK, BorderedBox } from '../helpers/helpers';

import { Slider, Grid, Button, List, ListItem, ListItemText } from '@mui/material';
...
export const AdminView = () => {
    ...
    const sliderVisible = (
        runMode === RUNMODE_MOCK ? slider : <div />
    );
    ...
    const reorderViews = (
        <div>
        <List onDragOver={handleDragOver} style={{ display: 'flex', flexDirection: 'row' }}>
